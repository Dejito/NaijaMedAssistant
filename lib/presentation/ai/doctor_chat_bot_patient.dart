...
class DoctorsChatBoxPatient extends StatefulWidget {
  static const route = '/doctor-chat-box';

  const DoctorsChatBoxPatient({super.key});
...
class _DoctorsChatBoxPatientState extends State<DoctorsChatBoxPatient> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: msg.isMe ? CrossAxisAlignment.start : CrossAxisAlignment.start,
              children: [
                Text(
                  msg.text,
                  style: TextStyle(
  ...
  Widget _buildCallStatusCard(DoctorMessage msg) {
    ...
    if (!isEnded) {
      // Standard inline compact cell layout variant
      return Container(
        margin: const EdgeInsets.symmetric(vertical: 6),
        padding: const EdgeInsets.all(14),
        decoration: BoxDecoration(
    ...
    // Extended Video Call Ended Component card alignment block layout matches right panel offset
    return Align(
  ...
  Widget _buildPrescriptionCard(DoctorMessage msg) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Floating Action View Trigger Style Anchor Header Capsule UI
          Container(
          ...
          // Structured Medical Matrix Grid Rows Loop Layout Mapping logic
          ListView.builder(
            shrinkWrap: true,
  ...
  // --- Core Utility Platform Render Atoms ---
...
class DoctorMessage {
  ...
  final String? callDuration; // For call logs
  final List<PrescriptionItem>? prescriptions; // For prescription blocks
